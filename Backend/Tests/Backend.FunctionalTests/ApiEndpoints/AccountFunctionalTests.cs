...
using Backend.FunctionalTests.Common;
using Shouldly;

namespace Backend.FunctionalTests.ApiEndpoints;

[Collection("AccountFunctionalTests")]
public class AccountFunctionalTests(CustomWebApplicationFactory<Program> factory)
